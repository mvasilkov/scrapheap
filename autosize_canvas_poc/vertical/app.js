...
const canvas = new CanvasHandle(document.querySelector('#canvas1'), 540, 960)
...
// const autoscale = new AutoScaleWrapper(document.querySelector('#autoscale1'), 540, 960)
const autoscale = new AutoRotateWrapper(document.querySelector('#autoscale1'), 540, 960)
