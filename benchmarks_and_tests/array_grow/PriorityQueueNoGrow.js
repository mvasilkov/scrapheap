...
exports.PriorityQueueNoGrow = void 0;
var PriorityQueueNoGrow = /** @class */ (function () {
    function PriorityQueueNoGrow(params) {
        var _this = this;
        this.values = [];
        this.length = 0;
    ...
    PriorityQueueNoGrow.prototype.insert = function (value) {
    ...
    PriorityQueueNoGrow.prototype.remove = function () {
        if (this.length === 0)
            return null;
    ...
    PriorityQueueNoGrow.prototype.heapsort = function () {
        var _this = this;
        return Array.from({ length: this.length }, function () { return _this.remove(); });
    };
    PriorityQueueNoGrow.prototype.parent = function (nodeIndex) {
        if (nodeIndex === 0)
            return null;
        return (nodeIndex - 1) >>> 1;
    };
    PriorityQueueNoGrow.prototype.leftChild = function (nodeIndex) {
        var child = (nodeIndex * 2) + 1;
        if (child >= this.length)
            return null;
        return child;
    };
    PriorityQueueNoGrow.prototype.rightChild = function (nodeIndex) {
        var child = (nodeIndex * 2) + 2;
        if (child >= this.length)
            return null;
        return child;
    };
    PriorityQueueNoGrow.prototype.bubbleUp = function () {
    ...
    PriorityQueueNoGrow.prototype.bubbleDown = function () {
        var index = 0;
        while (true) {
    ...
    return PriorityQueueNoGrow;
}());
exports.PriorityQueueNoGrow = PriorityQueueNoGrow;
