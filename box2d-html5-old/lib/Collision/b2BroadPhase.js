...
define(["goog", "box2d.b2Settings", "box2d.b2DynamicTree"], function (goog, box2d) {
...
// -removed- goog.provide('box2d.b2BroadPhase')
...
box2d.b2BroadPhase = function ()
{
	...
	this.m_moveBuffer = Array();
	this.m_pairBuffer = Array();
};
