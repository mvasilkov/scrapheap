...
define(["goog", "box2d.b2Settings", "box2d.b2Draw", "box2d.b2ContactManager", "box2d.b2ContactSolver", "box2d.b2Island", "box2d.b2Body", "box2d.b2Math", "box2d.b2Collision", "box2d.b2TimeStep", "box2d.b2WorldCallbacks"], function (goog, box2d) {
...
// -removed- goog.provide('box2d.b2World');
...
// -removed- goog.require('box2d.b2ContactManager');
if (typeof box2d.b2ContactManager === "undefined")
    throw new Error("I can haz box2d.b2ContactManager?")

// -removed- goog.require('box2d.b2ContactSolver');
if (typeof box2d.b2ContactSolver === "undefined")
    throw new Error("I can haz box2d.b2ContactSolver?")

// -removed- goog.require('box2d.b2Island');
if (typeof box2d.b2Island === "undefined")
    throw new Error("I can haz box2d.b2Island?")
