...
define(["goog", "box2d.b2Settings", "box2d.b2Contact", "box2d.b2CollidePolygon"], function (goog, box2d) {
...
// -removed- goog.provide('box2d.b2PolygonContact');
...
// -removed- goog.require('box2d.b2CollidePolygon');
if (typeof box2d.b2CollidePolygon === "undefined")
    throw new Error("I can haz box2d.b2CollidePolygon?")
