...
define(["goog", "box2d.b2Settings", "box2d.b2Math", "box2d.b2Collision", "box2d.b2CircleContact", "box2d.b2PolygonAndCircleContact", "box2d.b2PolygonContact", "box2d.b2EdgeAndCircleContact", "box2d.b2EdgeAndPolygonContact", "box2d.b2ChainAndCircleContact", "box2d.b2ChainAndPolygonContact"], function (goog, box2d) {
...
// -removed- goog.provide('box2d.b2ContactSolver');
if (typeof box2d === "undefined")
    box2d = {}
if (typeof box2d.b2ContactSolver === "undefined")
...
if (typeof box2d.b2Math === "undefined")
    throw new Error("I can haz box2d.b2Math?")

// -removed- goog.require('box2d.b2Collision');
if (typeof box2d.b2Collision === "undefined")
    throw new Error("I can haz box2d.b2Collision?")

// -removed- goog.require('box2d.b2CircleContact');
if (typeof box2d.b2CircleContact === "undefined")
    throw new Error("I can haz box2d.b2CircleContact?")

// -removed- goog.require('box2d.b2PolygonAndCircleContact');
if (typeof box2d.b2PolygonAndCircleContact === "undefined")
    throw new Error("I can haz box2d.b2PolygonAndCircleContact?")

// -removed- goog.require('box2d.b2PolygonContact');
if (typeof box2d.b2PolygonContact === "undefined")
    throw new Error("I can haz box2d.b2PolygonContact?")

// -removed- goog.require('box2d.b2EdgeAndCircleContact');
if (typeof box2d.b2EdgeAndCircleContact === "undefined")
    throw new Error("I can haz box2d.b2EdgeAndCircleContact?")

// -removed- goog.require('box2d.b2EdgeAndPolygonContact');
if (typeof box2d.b2EdgeAndPolygonContact === "undefined")
    throw new Error("I can haz box2d.b2EdgeAndPolygonContact?")

// -removed- goog.require('box2d.b2ChainAndCircleContact');
if (typeof box2d.b2ChainAndCircleContact === "undefined")
    throw new Error("I can haz box2d.b2ChainAndCircleContact?")

// -removed- goog.require('box2d.b2ChainAndPolygonContact');
if (typeof box2d.b2ChainAndPolygonContact === "undefined")
    throw new Error("I can haz box2d.b2ChainAndPolygonContact?")
